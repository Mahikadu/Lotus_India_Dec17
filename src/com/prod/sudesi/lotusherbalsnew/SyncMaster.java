...
import libs.ImageUtils;
import libs.ImageUtils_btimap;
...
public class SyncMaster extends Activity {
	...
	public class syncAllData extends AsyncTask<Void, Void, SoapObject> {
		...
		protected void onPostExecute(SoapObject result) {
			...
			/*	AlertDialog.Builder builder = new AlertDialog.Builder(SyncMaster.this);
				builder.setMessage("Connectivity Error Please check internet")
						.setCancelable(false)
						.setPositiveButton("OK", new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int id) {
								//do things
			...
			/*	Toast.makeText(getApplicationContext(),
						"Connectivity Error Please check internet ",
						Toast.LENGTH_SHORT).show();*/
			}
			Log.d("Errr flag is", "" + ErroFlag);
			if (ErroFlag.equalsIgnoreCase("0")) {

				DisplayDialogMessage("Uploading data Incomplete !! Try again");
