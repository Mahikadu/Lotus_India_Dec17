...
//	Spinner spin_mrp;
	...
	public LazyAdapter3(Activity a, String[] d, String[] q, String[] spinnerId,
			String[] menuGroupId, String getflag, String[] db_id,
			String[] eancode, String[] cat_id, String[] shade , DataHolder[] objects) {
...
//			spin_mrp = (Spinner) vi.findViewById(R.id.spin_mrp);
//			
//			spin_mrp.setAdapter(dataHolder.getAdapter());
//			
//			spin_mrp.setOnItemSelectedListener(new OnItemSelectedListener() {
//
//                @Override
//                public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
//                    dataHolder.setSelected(arg2);
...
//		spin_mrp.setSelection(getItem(position).)
