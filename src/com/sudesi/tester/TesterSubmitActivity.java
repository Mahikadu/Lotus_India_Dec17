...
import com.prod.sudesi.lotusherbalsnew.TesterFragment;
...
public class TesterSubmitActivity extends Activity {
	...
	com.sudesi.adapter.LazyAdapter2 productadapter;	
...
//			String shadeno[]= new String[cursor.getCount()];
			...
			//			TesterFragment.this, products,size,id);
				...
				productadapter = new com.sudesi.adapter.LazyAdapter2(
